            ...
            <table class="table table-bordered table-hover table-striped table-responsive">
                ...
                <tbody id="myTable">
                    ...
                    <tr>
                        ...
                        <td><?php echo $dish['d_name']; ?></td>
                        <td><?php echo $dish['d_about']; ?></td>
                        <td><?php echo $dish['d_price']; ?></td>
                        <td>
                            <a href="<?php echo base_url().'manager/menu/edit/'.$dish['d_id']; ?>"
...
function deleteMenu(id) {
    if (confirm("Are you sure you want to delete dish?")) {
        window.location.href = '<?php echo base_url().'manager/menu/delete/';?>' + id;
    }
}
