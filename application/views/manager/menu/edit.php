<div class="conatiner">
    <form id="myForm" action="<?php echo base_url().'manager/menu/edit/'.$dish['d_id'];?>" method="POST"
        class="form-container mx-auto  shadow-container" style="width:80%" enctype="multipart/form-data">
        <h3 class="mb-3">Edit Dish "<?php echo $dish['d_name']; ?>"</h3>
        <div class="form-group">
            ...
            <select name="rname" id="resname"
                ...
                <option value="<?php echo $store['r_id'];?>">
                    <?php echo set_select('resname', $store['r_name']);?>
                    <?php echo $store['r_name'];?>
                </option>
                <?php }
                }
                ?>
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <?php echo (form_error('name') != "") ? 'is-invalid' : '';?>" name="name" id="name"
                        placeholder="Enter dish name" value="<?php echo set_value('name', $dish['d_name']); ?>">
                    <span></span>
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <?php echo (form_error('price') != "") ? 'is-invalid' : '';?>" id="price" name="price"
                        placeholder="Enter Price" value="<?php echo set_value('price', $dish['d_price']); ?>">
                    <span></span>
            ...
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <?php echo (form_error('about') != "") ? 'is-invalid' : '';?>" id="about" name="about"
                        placeholder="About" value="<?php echo set_value('about', $dish['d_about']); ?>">
                    <span></span>
            ...
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <?php if($dish['d_img'] != "" && file_exists('./public/uploads/dishesh/thumb/'.$dish['d_img'])) { ?>

                    <img src="<?php echo base_url().'public/uploads/dishesh/thumb/'.$dish['d_img'];?>">
        ...
        <a href="<?php echo base_url().'manager/menu/index'?>" class="btn btn-secondary">Back</a>
    </form>
</div>
<script>
