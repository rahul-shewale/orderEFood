<div class="conatiner">
    <form action="<?php echo base_url().'manager/store/add';?>" method="POST"
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="form-group">
                    ...
                    <?php echo (form_error('phone') != "") ? 'is-invalid' : '';?>" placeholder="10 digit phone number"
            ...
            <div class="col-md-6">
                ...
                <div class="form-group">
                    ...
                    <select name="o_days" id="o_days"
                        class="form-control <?php echo (form_error('o_days') != "") ? 'is-invalid' : '';?>">
