<div class="container shadow-container">
    ...
    <form action="<?php echo base_url().'manager/category/edit/'.$cat['c_id'];?>" class="container" method="POST" id="myForm">
        ...
        <a class="btn btn-secondary" href="<?php echo base_url().'manager/category/index';?>">Back</a>
    </form>
</div>
<script>
