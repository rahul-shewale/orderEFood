<div class="container shadow-container">
    ...
    <form action="<?php echo base_url().'manager/category/add';?>" class="container my-3" method="POST" id="myForm">
        ...
        <a class="btn btn-secondary" href="<?php echo base_url().'manager/category';?>">Back</a>
    </form>
</div>
