...
<body>
    <div class="wrapper container">
        ...
        <h2 class="text-center my-3">Create manager account</h2>
        <br><br>
        <form action="<?php echo base_url().'manager/singup/add'; ?>" method="POST" name="myForm" id="myForm"
            ...
            <p>Already registered? <a href="<?php echo base_url().'manager/login/index';?>">Sing in</a></p>
        </form>
    </div>
